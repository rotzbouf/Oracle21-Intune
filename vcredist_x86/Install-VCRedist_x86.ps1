...
<#
.SYNOPSIS
    Installs Microsoft Visual C++ 2015-2022 Redistributable (x86) — Intune Win32 deployment.

.DESCRIPTION
    Silent install of VC_redist.x86.exe bundled in the .intunewin package.
    ...
    Package folder layout:
        VC_redist.x86.exe           ← Microsoft VC++ 2015-2022 x86 installer
        Install-VCRedist_x86.ps1    (this file)
    ...
    Intune Win32 app settings:
        ...
        Detection        : Custom script — Detect-VCRedist_x86.ps1  /  Run as 32-bit: Yes
...
$LogFile       = "$LogDir\VCRedist_x86_Install.log"
# ─────────────────────────────────────────────────────────────────────────────
...
try {
    Write-Log "=== VCRedist 2015-2022 x86 — Install START ==="
    ...
    # ── Verify ─────────────────────────────────────────────────────────────────
    # 32-bit registry on a 64-bit OS lives under WOW6432Node
    ...
    Write-Log "=== VCRedist 2015-2022 x86 — Install SUCCESSFUL ==="
    Stop-Transcript
