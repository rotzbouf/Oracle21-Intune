<#
.SYNOPSIS
    Detection script for Oracle Database Client 21c (32-bit) — Intune Win32 custom detection.
...
.DESCRIPTION
    ...
    Checks:
        ...
        3. Registry key for this Oracle Home exists (WOW6432Node for 32-bit)
...
# 32-bit Oracle on 64-bit Windows registers under WOW6432Node
$RegistryPath = 'HKLM:\SOFTWARE\WOW6432Node\Oracle\KEY_OraClient21Home1_x86'
...
if ($allGood) {
    Write-Output "Oracle 21c x86 Runtime detected at $OracleHome"
    exit 0
} else {
    exit 0
}
