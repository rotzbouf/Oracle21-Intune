...
<#
.SYNOPSIS
    Uninstalls Microsoft Visual C++ 2015-2022 Redistributable (x64) — Intune Win32.
...
.NOTES
    ...
    Oracle 21c Client (x64) must be uninstalled BEFORE uninstalling this package.
#>
...
$LogFile       = "$LogDir\VCRedist_x64_Uninstall.log"
...
try {
    Write-Log "=== VCRedist 2015-2022 x64 — Uninstall START ==="
    ...
    if ($installed -ne 1) {
        Write-Log "VCRedist x64 not detected as installed. Nothing to do." 'WARN'
    ...
    Write-Log "=== VCRedist 2015-2022 x64 — Uninstall COMPLETE ==="
    Stop-Transcript
